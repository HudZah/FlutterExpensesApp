...
class _MyHomePageState extends State<MyHomePage> with WidgetsBindingObserver {
  ...
  @override
  dispose() {
    // Clear listeners, even if the state object should be deleted
  ...
  void _addNewTransaction(
    ...
    setState(() {
      ...
      // Although final, we only manipulate the array not the pointer (address), we just change the object
    });
  }
